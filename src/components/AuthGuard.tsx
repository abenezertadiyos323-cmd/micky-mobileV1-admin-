...
function SplashScreen() {
  return (
    ...
    >
      {/* Blurred colour blobs — no img file required */}
      <div
        style={{
          position: "absolute",
          width: 300,
      ...
      <h1
        style={{
          ...
          textShadow:
            "0 0 12px rgba(255,255,255,0.9), 0 0 30px rgba(253,224,71,0.5)",
          userSelect: "none",
        }}
      >
        MICKY{" "}
        <span style={{ color: "#FDE047" }}>MOBILE</span>
      </h1>
        ...
        {[0, 200, 400].map((delay) => (
          <span
            ...
            style={{
              ...
              background: "#FDE047",
              opacity: 0.8,
              animation: `mmPing 1.4s ${delay}ms ease-in-out infinite`,
            }}
          />
        ))}
      </div>
